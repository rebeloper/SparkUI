...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/rebeloper/Layoutless.git", .upToNextMajor(from: "0.4.5")),
        .package(url: "https://github.com/rebeloper/SparkExtensions.git", .upToNextMajor(from: "0.0.11")),
